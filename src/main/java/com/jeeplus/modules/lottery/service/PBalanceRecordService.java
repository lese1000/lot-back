...
public class PBalanceRecordService extends CrudService<PBalanceRecordDao, PBalanceRecord> {
	...
	public List<PlayerBalanceVo> findBalanceByVo(PlayerBalanceVo vo) {
		return dao.findBalanceByVo(vo);
	}
	
	public List<PlayerBalanceVo> findBalanceByVoForParent(PlayerBalanceVo vo) {
		return dao.findBalanceByVoForParent(vo);
	}
