...
<!-- 				<th> <input type="checkbox" class="i-checks"></th> -->
				<th  class="sort-column playerId">序号</th>
				<th  class="sort-column playerId">玩家名称</th>
				<th  class="sort-column ipAddr">ip地址</th>
				<th  class="sort-column createDate">登录时间</th>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="pLoginRecord" varStatus="status">
			<tr>
<!-- 				<td> <input type="checkbox" id="${pLoginRecord.id}" class="i-checks"></td> -->
				<td>${ status.index + 1}</td>  
				<td>
					${pLoginRecord.playerName}
				</td>
				<td>
					${pLoginRecord.ipAddr}
				</td>
