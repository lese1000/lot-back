...
<body class="gray-bg">
	...
	<div class="ibox-title">
		<h5>${pPlayer.playerName}玩家下级账号列表 </h5>
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="pPlayer" action="${ctx}/sys/pPlayer/nextPlayerList?playerId=${pPlayer.playerId}" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		...
		<div class="pull-right">
			<a  href="${ctx}/sys/pPlayer/" class="btn btn-primary btn-rounded btn-outline btn-sm "  ><i class="fa fa-search"></i> 返回上一级</a>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="pPlayer">
			<tr>
				<td> <input type="checkbox" id="${pPlayer.playerId}" class="i-checks"></td>
				<td><a  href="#" onclick="openDialogView('查看玩家账号', '${ctx}/sys/pPlayer/form?id=${pPlayer.playerId}','800px', '500px')">
					${pPlayer.playerName}
				</a></td>
				<td>
				...
				<td>
					<shiro:hasPermission name="sys:pPlayer:view">
						<a href="#" onclick="openDialogView('查看玩家账号', '${ctx}/sys/pPlayer/form?playerId=${pPlayer.playerId}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="sys:pPlayer:edit">
    					<a href="#" onclick="openDialog('修改玩家账号', '${ctx}/sys/pPlayer/form?playerId=${pPlayer.playerId}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="sys:pPlayer:del">
						<a href="${ctx}/sys/pPlayer/delete?playerId=${pPlayer.playerId}" onclick="return confirmx('确认要删除该玩家账号吗？', this.href)"   class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> 删除</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
