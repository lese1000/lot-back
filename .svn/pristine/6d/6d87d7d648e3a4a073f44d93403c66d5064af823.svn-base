...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="playerBalanceVo" action="${ctx}/lottery/pBalanceReport/list" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column bt5">活动奖励金额</th>
				<th  class="sort-column bt6">积分兑换金额</th>
			</tr>
		</thead>
		<tbody>
